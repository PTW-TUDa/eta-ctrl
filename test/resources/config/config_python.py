config = {  # noqa: INP001
    "setup": {
        "environment_import": "eta_ctrl.eta_x.envs.BaseEnvMPC",
        "agent_import": "eta_ctrl.eta_x.agents.MPCBasic",
        "interaction_env_class": "BaseEnvMPC",
        "interaction_env_package": "eta_ctrl.eta_x.envs",
        "vectorizer_class": "DummyVecEnv",
        "vectorizer_package": "stable_baselines3.common.vec_env.dummy_vec_env",
        "policy_class": "NoPolicy",
        "policy_package": "eta_ctrl.eta_x.common",
    },
