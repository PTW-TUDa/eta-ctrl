...
from eta_ctrl.eta_x.config import ConfigOpt, ConfigOptSettings, ConfigOptSetup
...
class TestConfigOptSetup:
    ...
    def test_class_not_found(self, config_dict: dict):
        config_dict["setup"]["environment_import"] = "eta_ctrl.eta_x.envs.FooBar"
        error_msg = (
            "Could not find class 'FooBar' in module 'eta_ctrl.eta_x.envs'. "
