...
.. autoclass:: eta_ctrl.eta_x.common::NoPolicy
    :noindex:
...
.. autoclass:: eta_ctrl.eta_x.common::LinearSchedule
    :noindex:
...
.. autoclass:: eta_ctrl.eta_x.common::CustomExtractor
    :noindex:

    The architecture of the feature extractor is controlled by the ``net_arch`` parameter.
    It is able to handle observations which consist of classic, time-independent data **and** multiple time series. See below for an explanation of how this parameter is interpreted using :py:func:`eta_ctrl.eta_x.common.common.deserialize_net_arch`.
...
.. autofunction:: eta_ctrl.eta_x.common::deserialize_net_arch
    :noindex:
...
.. autoclass:: eta_ctrl.eta_x.common::Split1d
    :noindex:

.. autoclass:: eta_ctrl.eta_x.common::Fold1d
    :noindex:
