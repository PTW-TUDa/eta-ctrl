...
from eta_ctrl import deep_mapping_update, dict_pop_any, json_import
from eta_ctrl.util import toml_import, yaml_import
...
if TYPE_CHECKING:
    ...
    from eta_ctrl.type_hints import Path
...
class ConfigOptSetup:
    ...
    #: Import description string for the policy class (default: eta_ctrl.eta_x.agents.common.NoPolicy).
    policy_import: str = field(
        default="eta_ctrl.eta_x.common.NoPolicy",
        on_setattr=_get_class,
        converter=converters.default_if_none("eta_ctrl.eta_x.common.NoPolicy"),  # type: ignore
    )  # mypy currently does not recognize converters.default_if_none
