...
from eta_ctrl import dict_get_any, log_add_filehandler
...
if TYPE_CHECKING:
    ...
    from eta_ctrl.eta_x import ConfigOpt, ConfigOptRun
    from eta_ctrl.eta_x.envs import BaseEnv
    from eta_ctrl.type_hints import AlgoSettings, EnvSettings, Path
...
def deserialize_net_arch(
    ...
    the value will be interpreted as a data processor from :py:mod:`eta_ctrl.eta_x.common.processors`.
